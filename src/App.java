...
public class App {
    public static void main(String[] args) {
        ...
        WordTree arvoreIng = new WordTree();
        arvoreIng.lerArquivo("dictionary.csv");
        ...
        while(index != 1 && index != 2){
            ...
            index = in.nextInt();
            if(index != 1 || index != 2 || !in.hasNextInt()){
        ...
        if(index == 1){
            ...
            List<Palavra> palavras = arvoreIng.searchAll(caracteres);
